...
\titleformat{\chapter}[hang]{\bfseries\Large\centering}{\thechapter}{1em}{\MakeUppercase}
...
\renewcommand{\appendix}{%
  ...
  \titleformat{\chapter}{\Large\bfseries\centering}{\MakeUppercase{\appendixname}\ \thechapter}{4pt}{}
}
